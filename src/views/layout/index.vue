      ...
      <el-header class="header">
        ...
        <el-dropdown>
          <div class="avatar-wrap">
            <img class="avatar" :src="user.headPortrait" alt="">
            <span>{{ user.username }}</span>
            <i class="el-icon-arrow-down el-icon--right"></i>
          </div>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="reDirectSet">设置</el-dropdown-item>
            <!--
...
export default {
  ...
  created () {
    ...
    globalBus.$on('update-user', (data) => {
      ...
      this.user.headPortrait = data.headPortrait
    })
  },
  mounted () {},
  methods: {
    ...
    loadUserProfile () {
      ...
      // })
      console.log("setting:" + window.localStorage.getItem("user"))
      this.user = JSON.parse(window.localStorage.getItem("user"))
    },

    reDirectSet () {
      this.$router.push('/content/settings')
    },
