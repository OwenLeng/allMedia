    ...
    <el-card class="filter-card">
      ...
      <el-form ref="form" :model="form" label-width="40px" size="mini">
        ...
        <el-form-item>
          ...
          -->
          <el-button type="primary"  @click="loadArticles(user_id)"
            >查询</el-button
          >
        </el-form-item>
      </el-form>
        ...
        <el-table-column label="操作">
          ...
          <template slot-scope="scope">
            <el-button
              ...
              icon="el-icon-edit"
              type="primary"
              @click="$router.push('/content/publish?id=' + scope.row.id.toString())"
            ></el-button>
            <el-button
              size="mini"
              type="danger"
...
export default {
  ...
  data() {
    return {
      ...
      totalCount: 0, //总数据条数
      pageSize: 10, //每页大小
      status: 5, //查询文章的状态 不传就是全部状态
      categories: ['全部', '热点观察', '中特研究', '伦理道德', '中国与世界', '大国关系', '全球治理'], //文章类型列表
